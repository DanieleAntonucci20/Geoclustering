...
# GeoclusteringEurac documentation build
...
from GeoclusteringEurac import __version__ as release

# -- Project information -----------------------------------------------------

project = "GeoclusteringEurac"
copyright = "2021, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "GeoclusteringEuracdoc"
...
latex_documents = [
    (
        master_doc,
        "GeoclusteringEurac.tex",
        "GeoclusteringEurac Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "GeoclusteringEurac",
        "Project GeoclusteringEurac codebase.",
        "Data-Science",
    )
]
