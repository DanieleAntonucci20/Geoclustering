...
<head>
  ...
  <title>kedro.framework.cli.pipeline &mdash; Kedro 0.17.4 documentation</title>
...
<li class="toctree-l3"><a class="reference internal" href="../../../../06_nodes_and_pipelines/03_modular_pipelines.html#package-a-modular-pipeline">Package a modular pipeline</a></li>
<li class="toctree-l3"><a class="reference internal" href="../../../../06_nodes_and_pipelines/03_modular_pipelines.html#pull-a-modular-pipeline">Pull a modular pipeline</a></li>
</ul>
</li>
...
<span></span><span class="c1"># Copyright 2021 QuantumBlack Visual Analytics Limited</span>
<span class="c1">#</span>
...
<span class="kn">from</span> <span class="nn">typing</span> <span class="kn">import</span> <span class="n">Any</span><span class="p">,</span> <span class="n">List</span><span class="p">,</span> <span class="n">NamedTuple</span><span class="p">,</span> <span class="n">Optional</span><span class="p">,</span> <span class="n">Tuple</span><span class="p">,</span> <span class="n">Union</span>
...
<span class="n">PipelineArtifacts</span> <span class="o">=</span> <span class="n">NamedTuple</span><span class="p">(</span>
    <span class="s2">&quot;PipelineArtifacts&quot;</span><span class="p">,</span>
    <span class="p">[(</span><span class="s2">&quot;pipeline_dir&quot;</span><span class="p">,</span> <span class="n">Path</span><span class="p">),</span> <span class="p">(</span><span class="s2">&quot;pipeline_tests&quot;</span><span class="p">,</span> <span class="n">Path</span><span class="p">),</span> <span class="p">(</span><span class="s2">&quot;pipeline_conf&quot;</span><span class="p">,</span> <span class="n">Path</span><span class="p">)],</span>
<span class="p">)</span>
...
<span class="k">def</span> <span class="nf">list_pipelines</span><span class="p">():</span>
    <span class="sd">&quot;&quot;&quot;List all pipelines defined in your pipeline_registry.py file.&quot;&quot;&quot;</span>
...
<span class="p">):</span>  <span class="c1"># pylint: disable=unused-argument, protected-access</span>
    <span class="sd">&quot;&quot;&quot;Describe a pipeline by providing a pipeline name. Defaults to the __default__ pipeline.&quot;&quot;&quot;</span>
...
<span class="nd">@click</span><span class="o">.</span><span class="n">argument</span><span class="p">(</span><span class="s2">&quot;package_path&quot;</span><span class="p">,</span> <span class="n">nargs</span><span class="o">=</span><span class="mi">1</span><span class="p">)</span>
<span class="nd">@env_option</span><span class="p">(</span>
...
<span class="p">)</span>
<span class="nd">@click</span><span class="o">.</span><span class="n">pass_obj</span>  <span class="c1"># this will pass the metadata as first argument</span>
<span class="k">def</span> <span class="nf">pull_package</span><span class="p">(</span>
    <span class="n">metadata</span><span class="p">:</span> <span class="n">ProjectMetadata</span><span class="p">,</span> <span class="n">package_path</span><span class="p">,</span> <span class="n">env</span><span class="p">,</span> <span class="n">alias</span><span class="p">,</span> <span class="n">fs_args</span><span class="p">,</span> <span class="o">**</span><span class="n">kwargs</span>
<span class="p">):</span>  <span class="c1"># pylint:disable=unused-argument</span>
...
<span class="k">def</span> <span class="nf">package_pipeline</span><span class="p">(</span>
    <span class="n">metadata</span><span class="p">:</span> <span class="n">ProjectMetadata</span><span class="p">,</span> <span class="n">name</span><span class="p">,</span> <span class="n">env</span><span class="p">,</span> <span class="n">alias</span><span class="p">,</span> <span class="n">destination</span><span class="p">,</span> <span class="n">version</span>
...
<span class="p">):</span>
    ...
    <span class="k">if</span> <span class="n">test_source</span><span class="o">.</span><span class="n">is_dir</span><span class="p">():</span>
        <span class="n">_sync_dirs</span><span class="p">(</span><span class="n">test_source</span><span class="p">,</span> <span class="n">test_dest</span><span class="p">)</span>
    ...
    <span class="k">if</span> <span class="n">package_source</span><span class="o">.</span><span class="n">is_dir</span><span class="p">():</span>
        <span class="n">_sync_dirs</span><span class="p">(</span><span class="n">package_source</span><span class="p">,</span> <span class="n">package_dest</span><span class="p">)</span>
...
<span class="p">)</span> <span class="o">-&gt;</span> <span class="n">Path</span><span class="p">:</span>
    ...
    <span class="k">if</span> <span class="ow">not</span> <span class="n">version</span><span class="p">:</span>  <span class="c1"># default to pipeline package version</span>
        <span class="k">try</span><span class="p">:</span>
            ...
            <span class="p">)</span>
            <span class="n">version</span> <span class="o">=</span> <span class="n">pipeline_module</span><span class="o">.</span><span class="n">__version__</span>  <span class="c1"># type: ignore</span>
        <span class="k">except</span> <span class="p">(</span><span class="ne">AttributeError</span><span class="p">,</span> <span class="ne">ModuleNotFoundError</span><span class="p">):</span>
            ...
            <span class="n">version</span> <span class="o">=</span> <span class="n">project_module</span><span class="o">.</span><span class="n">__version__</span>  <span class="c1"># type: ignore</span>

    <span class="n">_generate_wheel_file</span><span class="p">(</span>  <span class="c1"># type: ignore</span>
        <span class="n">pipeline_name</span><span class="p">,</span> <span class="n">destination</span><span class="p">,</span> <span class="n">source_paths</span><span class="p">,</span> <span class="n">version</span><span class="p">,</span> <span class="n">alias</span><span class="o">=</span><span class="n">alias</span>
    <span class="p">)</span>
...
<span class="p">)</span> <span class="o">-&gt;</span> <span class="kc">None</span><span class="p">:</span>
    ...
    <span class="k">with</span> <span class="n">tempfile</span><span class="o">.</span><span class="n">TemporaryDirectory</span><span class="p">()</span> <span class="k">as</span> <span class="n">temp_dir</span><span class="p">:</span>
        ...
        <span class="c1"># Copy source folders</span>
        <span class="n">target_paths</span> <span class="o">=</span> <span class="n">_get_package_artifacts</span><span class="p">(</span><span class="n">temp_dir_path</span><span class="p">,</span> <span class="n">package_name</span><span class="p">)</span>
        <span class="k">for</span> <span class="n">source</span><span class="p">,</span> <span class="n">target</span> <span class="ow">in</span> <span class="nb">zip</span><span class="p">(</span><span class="n">source_paths</span><span class="p">,</span> <span class="n">target_paths</span><span class="p">):</span>
            <span class="n">sync_func</span> <span class="o">=</span> <span class="n">_sync_path_list</span> <span class="k">if</span> <span class="nb">isinstance</span><span class="p">(</span><span class="n">source</span><span class="p">,</span> <span class="nb">list</span><span class="p">)</span> <span class="k">else</span> <span class="n">_sync_dirs</span>
            <span class="n">sync_func</span><span class="p">(</span><span class="n">source</span><span class="p">,</span> <span class="n">target</span><span class="p">)</span>  <span class="c1"># type: ignore</span>

        <span class="n">conf_target</span> <span class="o">=</span> <span class="n">target_paths</span><span class="p">[</span><span class="o">-</span><span class="mi">1</span><span class="p">]</span>
        ...
        <span class="n">setup_file</span> <span class="o">=</span> <span class="n">_generate_setup_file</span><span class="p">(</span><span class="n">package_name</span><span class="p">,</span> <span class="n">version</span><span class="p">,</span> <span class="n">temp_dir_path</span><span class="p">)</span>
...
<span class="k">def</span> <span class="nf">_generate_setup_file</span><span class="p">(</span><span class="n">package_name</span><span class="p">:</span> <span class="nb">str</span><span class="p">,</span> <span class="n">version</span><span class="p">:</span> <span class="nb">str</span><span class="p">,</span> <span class="n">output_dir</span><span class="p">:</span> <span class="n">Path</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="n">Path</span><span class="p">:</span>
    ...
    <span class="n">package_data</span> <span class="o">=</span> <span class="p">{</span>
        <span class="n">package_name</span><span class="p">:</span> <span class="p">[</span>
            ...
            <span class="s2">&quot;config/parameters*&quot;</span><span class="p">,</span>
            <span class="s2">&quot;config/**/parameters*&quot;</span><span class="p">,</span>
            <span class="s2">&quot;config/parameters*/**&quot;</span><span class="p">,</span>
            <span class="s2">&quot;config/parameters*/**/*&quot;</span><span class="p">,</span>
        <span class="p">]</span>
    ...
    <span class="n">setup_file_context</span> <span class="o">=</span> <span class="nb">dict</span><span class="p">(</span>
        <span class="n">name</span><span class="o">=</span><span class="n">package_name</span><span class="p">,</span> <span class="n">version</span><span class="o">=</span><span class="n">version</span><span class="p">,</span> <span class="n">package_data</span><span class="o">=</span><span class="n">json</span><span class="o">.</span><span class="n">dumps</span><span class="p">(</span><span class="n">package_data</span><span class="p">)</span>
    <span class="p">)</span>
...
<span class="k">def</span> <span class="nf">_sync_dirs</span><span class="p">(</span><span class="n">source</span><span class="p">:</span> <span class="n">Path</span><span class="p">,</span> <span class="n">target</span><span class="p">:</span> <span class="n">Path</span><span class="p">,</span> <span class="n">prefix</span><span class="p">:</span> <span class="nb">str</span> <span class="o">=</span> <span class="s2">&quot;&quot;</span><span class="p">):</span>
...
<span class="sd">    &quot;&quot;&quot;</span>
    ...
    <span class="k">else</span><span class="p">:</span>
        <span class="n">content</span> <span class="o">=</span> <span class="p">[]</span>  <span class="c1"># nothing to copy</span>
    ...
    <span class="k">for</span> <span class="n">source_path</span> <span class="ow">in</span> <span class="n">content</span><span class="p">:</span>
        ...
        <span class="k">if</span> <span class="p">(</span>  <span class="c1"># rule #1</span>
            <span class="n">source_name</span> <span class="ow">in</span> <span class="n">existing_files</span>
...
<span class="k">def</span> <span class="nf">_delete_artifacts</span><span class="p">(</span><span class="o">*</span><span class="n">artifacts</span><span class="p">:</span> <span class="n">Path</span><span class="p">):</span>
  ...
  <div role="contentinfo">
    <p>
        &copy; Copyright 2021, QuantumBlack Visual Analytics Limited.
